...
Config.ScenarioPeds = 0.0 -- Like ambulance and cops 0.0 - 1.0

--

Config.disableCops = true 

Config.StealDrivingVehicle = false -- Prevent players from stealing driving NPC Vehicles

Config.DispatchService = false -- Disable all dispatches, such as NPC medics arriving to death scenes

Config.NPCGangsAttack = false -- Disable NPC gangs attacking users. Especially useful for making the bike gang & purple gang not constantly angry
